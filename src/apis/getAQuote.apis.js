...
export const createOrder = async (req, res) => {
  try {
    ...
    * {
    ...
    <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 18px; line-height: 25.2px; font-family: 'Crimson Text', serif;">Here's you have a new order quote:</span></p>
    <p style="font-size: 14px; line-height: 140%;">&nbsp;</p>
...
export const totalOrders = async (req, res) => {
  try {
    const count = await Quote.find({}).countDocuments("count").lean().exec();
