...
export const createQuestion = async (req, res) => {
  try {
     ...
     * {
     ...
     <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 18px; line-height: 25.2px; font-family: 'Crimson Text', serif;">Here's you have a new contact message:</span></p>
     <p style="font-size: 14px; line-height: 140%;">&nbsp;</p>
     <p style="font-size: 14px; line-height: 140%;">First Name: <strong>${body.firstName}</strong></p>
     <p style="font-size: 14px; line-height: 140%;">Last Name: <strong>${body.lastName}</strong></p>
...
export const totalQuestions = async (req, res) => {
  try {
    const count = await Question.find({}).countDocuments("count").lean().exec();
...
// GET TODAYS QUESTIONS
export const todaysQuestions = async (req, res) => {
  try {
